    ...
    return (
        <section id="contact">
            <div className="font-Poppins flex flex-col items-center gap-4 mx-4 lg:mx-40 mt-6 mb-8 text-white" style={{ borderTop: '5px solid #ffff00', color: 'white' }}>
                <h1 className="text-3xl m-2 font-bold" style={{ color: '#ffff00' }}>Contact Denis – Your catalyst for digital innovation</h1>
                ...
                <p className="text-700" style={{ color: '#ffff00' }}>&#169; copyright-Denis</p>
            </div>
        </section>
    );
};
